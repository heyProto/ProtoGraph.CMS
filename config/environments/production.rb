Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "pykih_publishing_#{Rails.env}"
  ...
  :email => {
    ...
    :exception_recipients => %w{ab@pro.to, r@pro.to, nasr@pro.to, mojo@pro.to, nidhi@pro.to, shivangi@pro.to}
  }
