...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { account_id: @permission.account_id, created_by: @permission.created_by, updated_by: @permission.updated_by, user_id: @permission.user_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { account_id: @permission.account_id, created_by: @permission.created_by, updated_by: @permission.updated_by, user_id: @permission.user_id } }
