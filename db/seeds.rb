...
t_share = TemplateDatum.create({git_url: "git@github.com:pykih/ProtoGraph.Schemas.git", git_branch: "master", name: "toSocial", account_id: icfj_account.id, created_by: user_id, updated_by: user_id})
