...
TemplateCard.create({git_url: "git@github.com:pykih/ProtoGraph.Card.toBrandAnIntersection.git", git_branch: "master", name: "toBrandAnIntersection", status: "published", is_public: true, account_id: icfj_account.id, created_by: user_id, updated_by: user_id, template_datum_id: t_brand.id})
