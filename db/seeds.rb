...
TemplateCard.create({git_url: "git@bitbucket.org:pykih_/protograph.card.tocoverimage.git", name: "toCoverImage", git_branch: "master", git_repo_name: "ProtoGraph.Card.toCoverImage", status: "published", is_public: false, account_id: pykih_account.id, created_by: user_id, updated_by: user_id, template_datum_id: t_image.id, elevator_pitch: "", description: "", s3_identifier: "99e448b6fcb668c5a3d4",has_multiple_uploads: true, is_editable: true, allowed_views: ["col16", "col7","col4", 'col3', 'col2']})
