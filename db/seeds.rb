...
t_story_link = TemplateDatum.create({name: "toStoryLink", version: "0.0.1", s3_identifier: "0dd3de0c92b4"})
t_tweet = TemplateDatum.create({name: "toTweet", version: "0.0.1", s3_identifier: "64a4217ed304"})
...
TemplateCard.create({git_url: "git@github.com:icfjknightfellows/ProtoGraph.Card.toStoryLink.git", name: "toStoryLink", git_branch: "master", git_repo_name: "ProtoGraph.Card.toStoryLink", status: "published", is_public: true, account_id: icfj_account.id, created_by: user_id, updated_by: user_id, template_datum_id: t_story_link.id, elevator_pitch: "To Story Link", description: "askdna ldknas ldknas ldknas ldknas dlkans dlkasnd laksnd laksn dalskdn aslkdn aslkd naslkd nasldk nasld knasld kansdl kasndl kasnd lasknd laksnd alskdn alskdnaslkdnal dknasl dknasld knas dlknas dlkansd lkansd laksnd lasknd alksndl aksndals kdnalsk ndalkdn alsknd alsd", s3_identifier: "62e2f4c97971"})
TemplateCard.create({git_url: "git@github.com:icfjknightfellows/ProtoGraph.Card.toTweet.git", name: "toTweet", git_branch: "master", git_repo_name: "ProtoGraph.Card.toTweet", status: "published", is_public: true, account_id: icfj_account.id, created_by: user_id, updated_by: user_id, template_datum_id: t_tweet.id, elevator_pitch: "To Tweet", description: "askdna ldknas ldknas ldknas ldknas dlkans dlkasnd laksnd laksn dalskdn aslkdn aslkd naslkd nasldk nasld knasld kansdl kasndl kasnd lasknd laksnd alskdn alskdnaslkdnal dknasl dknasld knas dlknas dlkansd lkansd laksnd lasknd alksndl aksndals kdnalsk ndalkdn alsknd alsd", s3_identifier: "6c1e1f03fa29"})
