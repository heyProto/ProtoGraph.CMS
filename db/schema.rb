...
ActiveRecord::Schema.define(version: 20180129160453) do
  ...
  create_table "pages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.text "cover_image_url", collation: "utf8_general_ci"
    t.text "cover_image_url_7_column", collation: "utf8_general_ci"
  ...
  create_table "ref_tags", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer "site_id"
    t.string "name", collation: "utf8_general_ci"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
...
>>>>>>> ac5d5c17b10fd1cb51b787253ed1fb4105944e28
  end
