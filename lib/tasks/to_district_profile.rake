...
district_mapping = {"Agra"=>"आगरा","Aligarh"=>"अलीगढ़","Allahabad"=>"इलाहाबाद","Ambedkar Nagar"=>"अम्बेडकरनगर","Amethi"=>"अमेठी","Amroha"=>"अमरोहा","Auraiya"=>"औरैया","Azamgarh"=>"आज़मगढ़","Baghpat"=>"बागपत","Bahraich"=>"बहराइच","Ballia"=>"बलिया","Balrampur"=>"बलरामपुर","Banda"=>"बाँदा","Barabanki"=>"बाराबंकी","Bareilly"=>"बरेली","Basti"=>"बस्ती","Bhadohi"=>"भदोही","Bijnor"=>"बिजनौर","Budaun"=>"बदायूँ","Bulandshahar"=>"बुलन्दशहर","Chandauli"=>"चन्दौली","Chitrakoot"=>"चित्रकूट","Deoria"=>"देवरिया","Etah"=>"एटा","Etawah"=>"इटावा","Faizabad"=>"फैज़ाबाद","Farrukhabad"=>"फर्रूखाबाद","Fatehpur"=>"फतेहपुर","Firozabad"=>"फिरोज़ाबाद","Gautam Buddha Nagar"=>"गौतमबुद्धनगर","Ghaziabad"=>"गाज़ियाबाद","Ghazipur"=>"गाज़ीपुर","Gonda"=>"गोण्डा","Gorakhpur"=>"गोरखपुर","Hamirpur"=>"हमीरपुर","Hapur"=>"हापुड़","Hardoi"=>"हरदोई","Hathras"=>"हाथरस","Jalaun"=>"जालौन","Jaunpur"=>"जौनपुर","Jhansi"=>"झांसी","Kannauj"=>"कन्नौज","Kanpur Dehat"=>"कानपुर देहात","Kanpur Nagar"=>"कानपुर नगर","Kasganj"=>"कासगंज","Kaushambi"=>"कौशाम्बी","Kushinagar"=>"कुशीनगर","Lakhimpur Kheri"=>"लखीमपुर खीरी","Lalitpur"=>"ललितपुर","Lucknow"=>"लखनऊ","Maharajganj"=>"महाराजगंज","Mahoba"=>"महोबा","Mainpuri"=>"मैनपुरी","Mathura"=>"मथुरा","Mau"=>"मऊ","Meerut"=>"मेरठ","Mirzapur"=>"मिर्ज़़ापुर","Moradabad"=>"मुरादाबाद","Muzaffarnagar"=>"मुजफ्फरनगर","Pilibhit"=>"पीलीभीत","Pratapgarh"=>"प्रतापगढ़","Raebareli"=>"रायबरेली","Rampur"=>"रामपुर","Saharanpur"=>"सहारनपुर","Sambhal"=>"सम्भल","Sant Kabir Nagar"=>"संत कबीर नगर","Shahjahanpur"=>"शाहजहाँपुर","Shamli"=>"शामली","Shravasti"=>"श्रावस्ती","Siddharth Nagar"=>"सिद्धार्थ नगर","Sitapur"=>"सीतापुर","Sonbhadra"=>"सोनभद्र","Sultanpur"=>"सुल्तानपुर","Unnao"=>"उन्नाव","Varanasi"=>"वाराणसी"}
...
namespace :to_district_profile do
    task :load_streams => :environment do
        ...
        account = Account.friendly.find(Rails.env.production? ? 'JagranNews' : "jagran")
