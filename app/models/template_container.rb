# == Schema Information
#
# Table name: template_containers
#
...
class TemplateContainer < ApplicationRecord
    #CONSTANTS
    include Associable
    include Versionable
    ...
    has_one :html, ->{where(genre: "html", attachable_type: "TemplateContainer")}, class_name: "ServicesAttachable", foreign_key: "attachable_id"
    has_one :css, ->{where(genre: "css", attachable_type: "TemplateContainer")}, class_name: "ServicesAttachable", foreign_key: "attachable_id"
    has_one :js, ->{where(genre: "js", attachable_type: "TemplateContainer")}, class_name: "ServicesAttachable", foreign_key: "attachable_id"
    has_one :config, ->{where(genre: "config", attachable_type: "TemplateContainer")}, class_name: "ServicesAttachable", foreign_key: "attachable_id"
