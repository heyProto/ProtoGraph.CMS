...
class RefCategory < ApplicationRecord
    ...
    def view_casts
        if genre == "series"
            ViewCast.where(template_card_id: TemplateCard.where(name: "toStory").pluck(:id)).where(is_autogenerated: true).where(series: self.name)
        elsif genre == 'intersection'
            ViewCast.where(template_card_id: TemplateCard.where(name: "toStory").pluck(:id)).where(is_autogenerated: true).where(genre: self.name)
        else
            ViewCast.where(template_card_id: TemplateCard.where(name: "toStory").pluck(:id)).where(is_autogenerated: true).where(sub_genre: self.name)
        end
