class StoriesController < ApplicationController
  ...
  def edit_assemble
    ...
    if @page.status != "draft"
        ...
        @all_cards = @site.view_casts.where.not(id: exclude_view_casts).where(is_autogenerated: false).where(folder_id: @site.folders.where(ref_category_vertical_id: @page.series.id, is_for_stories: true).pluck(:id)).order([:updated_at, :created_at])
