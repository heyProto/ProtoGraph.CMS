class SitesController < ApplicationController
  ...
  def site_params
    params.require(:site).permit(:show_proto_logo, :from_page, :account_id, :name, :domain, :sign_up_mode,:description, :primary_language, :tooltip_on_logo_in_masthead, :default_seo_keywords, :is_lazy_loading_activated, :is_smart_crop_enabled,:house_colour, :reverse_house_colour, :font_colour, :reverse_font_colour, :stream_url, :email_domain, :stream_id, :cdn_provider, :cdn_id, :host, :cdn_endpoint, :client_token, :access_token, :story_card_style, :client_secret, :g_a_tracking_id, :logo_image_id, :favicon_id, :default_role, :sign_up_mode, :header_background_color, :header_url, :header_positioning, :english_name, :is_english, :story_card_flip, :seo_name, :comscore_code, :gtm_id, :enable_ads, logo_image_attributes: [:image, :account_id, :is_logo, :created_by, :updated_by], favicon_attributes: [:image, :account_id, :is_favicon, :created_by, :updated_by])
  end
