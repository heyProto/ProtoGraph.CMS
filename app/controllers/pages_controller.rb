  ...
  def edit
    if @page.template_page.name == "article"
      ...
      if @page.template_page.name == "Homepage: Vertical"
        ...
        @all_cards = @site.view_casts.where.not(id: exclude_view_casts).where(is_autogenerated: false).where(folder_id: @site.folders.active.where(is_for_stories: true).pluck(:id)).order([updated_at: :desc, created_at: :desc])
