class PageTodosController < ApplicationController
  ...
  def create
    ...
    @page = @page_todo.page
    if @page_todo.save
      redirect_to edit_plan_account_site_story_path(@account, @site, @page, folder_id: @page.folder_id), notice: t("cs")
    else
  ...
  def destroy
    ...
    @page = @page_todo.page
    @page_todo.destroy
    redirect_to edit_plan_account_site_story_path(@account, @site, @page, folder_id: @page.folder_id), notice: t("ds")
  end
