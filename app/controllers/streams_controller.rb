class StreamsController < ApplicationController
    ...
    def stream_params
        params.require(:stream).permit(:account_id, :folder_id, :title, :description, :created_by, :updated_by, :limit, :offset, :order_by_key, :order_by_value, :include_data, :order_by_type,card_list: [], folder_list: [], tag_list: [], view_cast_id_list: [], excluded_view_cast_id_list: [])
    end
